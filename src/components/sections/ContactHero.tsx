  ...
  return (
    <section className="pt-32 pb-12 lg:pt-44 lg:pb-16 relative overflow-hidden">
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-20 left-1/3 w-[400px] h-[400px] bg-navy-100/20 rounded-full blur-3xl" />
      </div>
        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          <Reveal delay={0.3}>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 text-sm text-gray-500">
              <a href={`mailto:${contactInfo.email}`} className="inline-flex items-center gap-2 hover:text-accent-500 transition-colors">
