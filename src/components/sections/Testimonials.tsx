        ...
        <Stagger className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {testimonials.map((t) => (
            <StaggerItem key={t.author}>
              <div className="relative rounded-2xl bg-gradient-to-br from-neutral-50 to-white border border-gray-100 p-7 hover:shadow-lg hover:shadow-gray-100/50 transition-all duration-300 h-full flex flex-col">
                <Quote className="w-8 h-8 text-navy-200 mb-4 shrink-0" />
                <p className="text-sm text-gray-700 leading-relaxed flex-1 mb-6">
                  &ldquo;{t.quote}&rdquo;
                </p>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-accent-400 to-accent-600 flex items-center justify-center text-white text-xs font-bold">
