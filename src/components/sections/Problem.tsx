          ...
          <div className="max-w-lg">
            ...
            <Reveal delay={0.1}>
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold font-[family-name:var(--font-display)] text-gray-900 leading-tight mb-6">
                ...
                <span className="text-gray-300 line-through decoration-accent-400 decoration-2">máquinas</span>{' '}
                <span className="text-accent-500">personas</span>.
              </h2>
            </Reveal>
            <Reveal delay={0.2}>
            ...
            <Reveal delay={0.3}>
              <div className="relative inline-block">
                <div className="absolute inset-0 bg-gradient-to-r from-navy-100 to-accent-100 rounded-2xl blur-sm" />
                <div className="relative bg-white rounded-2xl px-8 py-6 border border-gray-100 shadow-sm">
                  <p className="text-base font-medium text-gray-800">
                    ...
                    <span className="text-accent-500 font-semibold">¿esto mejora la vida de alguien?</span>
                  </p>
                </div>
              </div>
            </Reveal>
