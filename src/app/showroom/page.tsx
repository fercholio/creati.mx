...
import { Sparkles, Tablet, CheckCircle, ArrowLeft, ShieldCheck, HeartHandshake } from 'lucide-react'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Showroom Interactivo & Play & Try | Creati.mx',
  description:
    'Explora y prueba en vivo aplicaciones de software a la medida para desarrollos inmobiliarios, hotelería, logística, clínicas y fintech en Mérida, Yucatán y México.',
}
      ...
      <Container>
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
          ...
          <p className="text-sm sm:text-base text-gray-600 mt-4 leading-relaxed max-w-2xl mx-auto">
            Haz clic en cualquiera de las soluciones para abrir el <strong>Estudio Interactivo en Vivo</strong>. Podrás ver la landing comercial, alternar roles de usuario y probar las funcionalidades operativas en un ambiente controlado.
          </p>

          <div className="mt-6 flex flex-wrap items-center justify-center gap-4 text-xs font-semibold text-gray-600">
            <span className="flex items-center gap-1.5"><CheckCircle className="w-4 h-4 text-emerald-500" /> Ambiente 100% Funcional</span>
            <span className="flex items-center gap-1.5"><CheckCircle className="w-4 h-4 text-emerald-500" /> Adaptado para iPad & Táctil</span>
            <span className="flex items-center gap-1.5"><CheckCircle className="w-4 h-4 text-emerald-500" /> Enfoque Mérida, Sureste & Centro</span>
          </div>
        </div>
