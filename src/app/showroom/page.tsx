...
import { ShowroomClientView } from '@/components/showroom/ShowroomClientView'
import { Zap, CheckCircle, HeartHandshake } from 'lucide-react'
  ...
  return (
    <main className="min-h-screen pt-28 sm:pt-36 pb-20 relative overflow-hidden bg-[#fafafa]">
      ...
      <Container>
        ...
        {/* Client-rendered Interactive Showroom & Brochure Cards */}
        <ShowroomClientView />
